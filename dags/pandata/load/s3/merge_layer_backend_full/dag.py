"""
Loads merge layer backend tables from S3 to GCS to BigQuery - full load
"""
...
from load.s3.constants import S3_BUCKET_PANDORA, ML_BE_AP_DIR
from load.s3.utils.tasks import load_table_and_update

with DAG(
    "load_merge_layer_backend_full_v1",
    ...
    TABLE_NAMES = [
        ...
        if t.is_full_load and isinstance(t, PandoraBigQueryTable)
    ]
