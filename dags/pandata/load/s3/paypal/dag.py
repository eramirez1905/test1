"""
Loads paypal tables from S3 to GCS to BigQuery
"""
...
from load.s3.constants import S3_BUCKET_PANDORA, PAYPAL_DIR
...
with DAG(
    ...
    sync_s3_to_gcs = S3ToGoogleCloudStorageTransferOperator(
        ...
        object_conditions={"includePrefixes": [f"{PAYPAL_DIR}/"]},
    )

    LOAD_DATASET = CONFIG.gcp.bigquery.get(PAYPAL_DATASET)
    FINAL_DATASET = CONFIG.gcp.bigquery.get(PAYPAL_LATEST_DATASET)
