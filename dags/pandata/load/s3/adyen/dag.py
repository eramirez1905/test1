"""
Loads adyen tables from S3 to GCS to BigQuery
"""
...
from load.s3.constants import ADYEN_DIR, S3_BUCKET_PANDORA
...
with DAG(
    ...
    sync_s3_to_gcs = S3ToGoogleCloudStorageTransferOperator(
        ...
        object_conditions={"includePrefixes": [f"{ADYEN_DIR}/"]},
    )

    LOAD_DATASET = CONFIG.gcp.bigquery.get(ADYEN_DATASET)
    FINAL_DATASET = CONFIG.gcp.bigquery.get(ADYEN_LATEST_DATASET)
