SELECT
  ...
  id,
  rdbms_id,
  `{project_id}`.pandata_intermediate.PD_UUID(basket_update_product_id, rdbms_id) AS basket_update_product_uuid,
  basket_update_product_id,
...
FROM `{project_id}.pandata_raw_ml_backend_latest.basket_update_product_topping`
