"""
Creates or updates views for intermediate layer for subscription data
"""
...
from configs.bigquery.tables.intermediate import SubscriptionBigQueryView
from constants.airflow import DEFAULT_ARGS, GOOGLE_CLOUD_CONN
from transform.intermediate.subscription.constants import SQL_DIR
from transform.intermediate.utils import add_upsert_view_ddl
from utils.file import read_sql

with DAG(
    "update_intermediate_layer__subscription_v1",
    ...
    for t in dataset.tables:
        if isinstance(t, SubscriptionBigQueryView):
            BigQueryOperator(
