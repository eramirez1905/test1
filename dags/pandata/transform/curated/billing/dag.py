"""
Transforms data from billing squad and output
tables in `pandata_curated` dataset

Source repo for logic reference
https://github.com/deliveryhero/pd-billing-asia
"""
