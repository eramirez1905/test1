"""
Transforms data from logistics' curated layer and output
...
from configs.bigquery.tables.curated import LogisticsTable
...
with DAG(
    "update_curated_layer__logistics_v1",
    ...
    for t in DATASET.tables:
        if isinstance(t, LogisticsTable):
