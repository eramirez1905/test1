...
RAW_DATASET_ACCESS = DatasetAccess(read=UserAccess(group_emails=(DATA_MEMBERS_EMAIL,)))

CURATED_DATASET_ACCESS = DatasetAccess(
    read=UserAccess(group_emails=(DATA_MEMBERS_EMAIL, DATA_ADVANCED_USERS_EMAIL)),
    write=UserAccess(group_emails=(DATA_MEMBERS_EMAIL,)),
)
...
BQ_CONFIG = BigQueryConfig(
    datasets=(
        ...
        BigQueryDataset(
            name=CURATED_DATASET, access=CURATED_DATASET_ACCESS, tables=CURATED_TABLES,
        ),
        BigQueryDataset(
