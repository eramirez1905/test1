...
ARG ADDITIONAL_PYTHON_DEPS="requests-oauthlib==1.1.0 oauthlib==2.1.0 Flask-OAuthlib==0.9.5 protobuf>=3.12.0 grpcio==1.29.0 slackclient==2.0.0 google-cloud-dataproc==1.0.0 argcomplete==1.11.1 apache-airflow-backport-providers-google apache-airflow-backport-providers-amazon apache-airflow-backport-providers-slack"
