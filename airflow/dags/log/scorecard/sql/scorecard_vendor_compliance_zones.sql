CREATE OR REPLACE TABLE rl.scorecard_vendor_compliance_zones AS
WITH parameters AS (
  ...
  SELECT o.country_code
    ...
    , COUNT(DISTINCT(IF(o.order_status = 'cancelled', o.order_id, NULL))) AS cancelled_orders_total
    , COUNT(DISTINCT(IF(o.order_status = 'cancelled' AND o.cancellation.source = 'dispatcher', o.order_id, NULL))) AS cancelled_orders
    , COUNT(DISTINCT(IF(o.order_status = 'cancelled' AND o.cancellation.source = 'dispatcher' AND o.cancellation.reason = 'TRAFFIC_MANAGER_VENDOR_CLOSED', o.order_id, NULL))) AS vendor_cancellations
    ...
    , COUNT(DISTINCT(IF(d.delivery_status = 'completed', o.order_id, NULL))) AS completed_orders
  FROM cl.orders o
