...
def generateFactOrdersUpserts(app_args):
    ...
    # Esquema ordenes
    s3_order_schema_path = "gs://data-ori-test-poc-storage/data-proc-test/schema/or_orders_schema.json"

    # Rutas de lectura y escritura
    s3_orders_last_event_path = app_args.s3_source_path
    s3_fact_orders_upsert = app_args.s3_destination_path
    ...
    conf = SparkConf().setAppName("ETL_fact_orders_upsert_kpis")
 ...
 ### STG DATA
    ...
    .option("temporaryGcsBucket","data-ori-test-poc-storage").option("intermediateFormat","orc")\
    .save("peya-data-pocs.testing_dataproc_nrt.orders_to_upsert")
