"""
Loads merge layer billing tables from S3 to GCS to BigQuery
"""
...
from configs.constructors.table import RawBigQueryTable
from load.s3.constants import S3_BUCKET_PANDORA, ML_BA_AP_DIR
from load.s3.utils.tasks import load_table_and_update

with DAG(
    "load_merge_layer_billing_v1",
    ...
    TABLE_NAMES = [
        t.name for t in FINAL_DATASET.tables if isinstance(t, RawBigQueryTable)
    ]
