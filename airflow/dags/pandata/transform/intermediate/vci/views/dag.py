"""
Creates or updates views for intermediate layer for vci data
"""
...
from configs.bigquery.tables.intermediate import VciBigQueryView
from constants.airflow import DEFAULT_ARGS, GOOGLE_CLOUD_CONN
from transform.intermediate.vci.views.constants import SQL_DIR
from transform.intermediate.utils import add_upsert_view_ddl
from utils.file import read_sql

with DAG(
    "update_intermediate_layer__vci_v1",
    ...
    for t in dataset.tables:
        if isinstance(t, VciBigQueryView):
            BigQueryOperator(
