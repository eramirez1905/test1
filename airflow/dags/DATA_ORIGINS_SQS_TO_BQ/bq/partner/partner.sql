drop table `peya-data-origins-stg.origin_data_refined.partner_origin`;

create table `peya-data-origins-stg.origin_data_refined.partner_origin`
PARTITION BY RANGE_BUCKET(country_id, GENERATE_ARRAY(0, 20, 1))
cluster by partner_id, business_type_id, partner_state_id, partner_type_id 
AS
